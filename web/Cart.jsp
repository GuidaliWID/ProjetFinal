...
<td style="text-align: center;">Total: <%=total%> DH</td>

<td style="text-align: center;"><form  action="AjouterCommande" method="get" ><input type="hidden" name="id" value="<%= p.getId()%>" class="form-input"><button type="submit" class="btn btn-primary btn-sm">Valider la commande</button></form></td>
